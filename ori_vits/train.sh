...
CUDA_VISIBLE_DEVICES=0,1,2,3 python /data/vitsGPT/vits/ori_vits/train.py -c /data/vitsGPT/vits/configs/onehour_ljs_sem_mat_text.json -m onehour_ljs_base
...
CUDA_VISIBLE_DEVICES=1 python /data/vitsGPT/vits/ori_vits/train.py -c /data/vitsGPT/vits/configs/emovdb_base.json -m emovdb_base_pretrained
